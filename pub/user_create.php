	...
	<div id='createNewUser'>
		...
		<table>
			<tr>
				...
				<td><input type='text' name='new_user_name' id='new_user_name' value='<?php echo($_REQUEST['new_user_name'])?>' /></td>
			</tr>
			<tr>
				<td style='text-align:right'>Email:</td>
				<td><input type='text' name='new_user_email' id='new_user_email' value='<?php echo($_REQUEST['new_user_email'])?>' /></td>
			</tr>
			<tr>
				<td style='text-align:right'>Password:</td>
				<td><input type='password' name='new_user_password' id='new_user_password' value='' /></td>
			</tr>
			<tr>
		...
		?>
		<input type='button' value='Create User' onClick="checkPasswordForm('createNewUserForm','new_user_password','new_user_password2')" /><input type='button' value='Cancel' onClick="removeBodyId('userDiv')"/>
	</div>
</form>